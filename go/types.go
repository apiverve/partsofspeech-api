...
// Request contains the parameters for the Parts Of Speech API.
//
// Parameters:
...
type Request struct {
	...
	Partofspeech string `json:"partofspeech"` // Required
}
...
// ResponseData contains the data returned by the Parts Of Speech API.
