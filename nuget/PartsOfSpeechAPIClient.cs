...
namespace APIVerve.API.PartsOfSpeech
{
    ...
    /// <summary>
    /// Client for the PartsOfSpeech API
    /// </summary>
...
#endif
    {
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "partofspeech", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public PartsOfSpeechAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PartsOfSpeechAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PartsOfSpeechAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        private void ValidateParams(PartsOfSpeechQueryOptions options)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(PartsOfSpeechQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(PartsOfSpeechQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(PartsOfSpeechQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(PartsOfSpeechQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(PartsOfSpeechQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
