...
```gradle
dependencies {
    implementation 'com.github.apiverve:partsofspeech-api:1.1.12'
}
```
...
```java
import com.apiverve.partsofspeech.PartsOfSpeechAPIClient;
import com.apiverve.partsofspeech.APIResponse;
import com.apiverve.partsofspeech.APIException;

// Initialize the client
PartsOfSpeechAPIClient client = new PartsOfSpeechAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/partsofspeech](https://docs.apiverve.com/ref/partsofspeech)
...
- **Documentation:** [https://docs.apiverve.com/ref/partsofspeech](https://docs.apiverve.com/ref/partsofspeech)
- **Issues:** [GitHub Issues](https://github.com/apiverve/partsofspeech-api/issues)
