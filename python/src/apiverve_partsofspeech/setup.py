...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/partsofspeech',
        'Source': 'https://github.com/apiverve/partsofspeech-api',
        'Bug Tracker': 'https://github.com/apiverve/partsofspeech-api/issues'
    },
    classifiers=[
