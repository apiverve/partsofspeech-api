...
class partsofspeechWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/partsofspeech');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/partsofspeech';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"text":{"type":"string","required":true},"partofspeech":{"type":"string","required":true,"default":"nouns"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/partsofspeech`);
        }
    }
...
module.exports = partsofspeechWrapper;
